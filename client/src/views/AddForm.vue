        ...
        <div class="mainBody">
          <form>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="resourceName" placeholder="Keep it short please!" maxlength="25" v-model="resourceName" required>
            </div>
            <!-- <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="detailedDescription" placeholder="Give me a brief description of it." maxlength="150" v-model="detailedDescription" required>
            </div>
            <div class="form-group">
